...
public class EventServiceImpl implements EventService {
    ...
    private void addLocation(EventDTO eventDTO, UUID eventId, UUID locationId) {
        System.out.println("In addLocation: " + eventId);
        System.out.println("In addLocation: " + eventDTO);
        System.out.println("In addLocation: " + eventDTO.getAdditionEvent());
        System.out.println("In addLocation: " +  eventDTO.getAdditionEvent().getLocation());
        System.out.println("In addLocation: " +  eventDTO.getAdditionEvent().getLocation());
        System.out.println("In addLocation: " +  eventId.toString());
